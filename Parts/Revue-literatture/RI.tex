...
\begin{figure}[htbp]
    \begin{center}
        \fbox{\includegraphics[width=15cm, angle=0]{Figures/ir-history.png}}
        \caption{Historique de la recherche d'information \citep{ir-course}}
    \end{center}
    \label{ir-history}
\end{figure}

Le principe de base de la recherche d'information est illustré dans la figure \ref{processus-ri}.

\begin{figure}[htbp]
    \begin{center}
        \fbox{\includegraphics[width=15cm, angle=0]{Figures/processus-ri-simple.png}}
...
\subsection{Facteur d'influence de la recherche d'information}
...
\begin{figure}[htbp]
    \begin{center}
        \fbox{\includegraphics[width=15cm, angle=0]{Figures/boolean-model-example.png}}
...
\begin{figure}[htbp]
    \begin{center}
        \fbox{\includegraphics[width=10cm, angle=0]{Figures/vector-model.png}}
...
\begin{figure}[htbp]
    \begin{center}
        \fbox{\includegraphics[width=15cm, angle=0]{Figures/probabilistic-model.png}}
